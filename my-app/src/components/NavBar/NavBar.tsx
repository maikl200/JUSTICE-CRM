    ...
    <div className={style.wrapper}>
      <nav className={style.nav}>
        ...
        <div className={style.nav_navElements}>
          <ButtonUI onClick={() => navigate('/mainPage')} icon='home' title='Main page' justifyContent='flex-start'
                    backgroundColor='white' color='#A8ADB2FF'
          ...
          <ButtonUI onClick={() => navigate('/mySales')} icon='percent' title='My sales' justifyContent='flex-start'
                    backgroundColor='white'
                    color='#A8ADB2FF'
                    backgroundColorHover='#F4F6FAFF' borderRight='1px solid #5382E7' colorHover='#5382E7'
                    padding='30px 40px' width='273px'/>
        ...
        <div className={style.nav_logOutBlock}>
          <ButtonUI onClick={() => navigate('/signIn')} icon='logout' title='Log out' justifyContent='flex-start'
                    backgroundColor='white' color='#A8ADB2FF'
                    backgroundColorHover='#F4F6FAFF' colorHover='#5382E7' padding='48px 0' width='194px'/>
        </div>
      </nav>
    </div>
  );
